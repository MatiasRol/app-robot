...
export default function MapDetailScreen() {
  ...
  const formatDate = (date: Date) => {
    ...
    return `${dayName} ${day} ${month} ${year} a las ${hours}:${minutes}`;
  };
  ...
  const onChangeNewDate = (event: any, selectedDate?: Date) => {
    setShowNewDatePicker(false);
    if (selectedDate) {
      setNewRouteDate(selectedDate);
    }
  };

  const onChangeNewTime = (event: any, selectedTime?: Date) => {
  ...
  const onChangeEditDate = (event: any, selectedDate?: Date) => {
    ...
    if (selectedDate) {
      setEditRouteDate(selectedDate);
    }
  };

  const onChangeEditTime = (event: any, selectedTime?: Date) => {
  ...
  return (
    <View style={styles.container}>
              ...
              {routes.map((route) => (
                <View key={route.id} style={styles.routeItem}>
                  <View style={styles.routeInfo}>
                    <Image
                      source={require('../../assets/images/IconMapaNav.png')}
      ...
      {/* Modal agregar ruta CON SELECTOR DE FECHA/HORA */}
      <Modal
      ...
      >
        ...
        {/* DateTimePicker para nueva ruta */}
        {showNewDatePicker && (
          <DateTimePicker
            value={newRouteDate}
            mode="date"
      ...
      {/* Modal editar ruta CON SELECTOR DE FECHA/HORA */}
      <Modal
      ...
      >
        ...
        {/* DateTimePicker para editar ruta */}
        {showEditDatePicker && (
          <DateTimePicker
            value={editRouteDate}
            mode="date"
        ...
        <View style={styles.alertOverlay}>
          <View style={styles.alertBox}>
            ...
            <Text style={styles.alertMessage}>
              ¿Estás seguro de que deseas cambiar el modo deoperación?
</Text>
