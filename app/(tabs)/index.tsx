...
// Replace with your actual robot image import
      ...
      <View style={styles.container}>
        ...
        <View style={styles.robotSection}>
          <View style={styles.robotImageContainer}>
            {/* Replace with actual Image component when you have the asset */}
            <View style={styles.robotImagePlaceholder}>
              <Ionicons name="hardware-chip-outline" size={80} color={Colors.textSecondary} />
            </View>
            {/* <Image source={RobotImage} style={styles.robotImage} resizeMode="contain" /> */}
          </View>
        ...
        <View style={styles.actionsRow}>
          ...
          >
            ...
            <Text style={styles.actionLabelSmall}>Mapa seleccionado</Text>
            <Text style={styles.actionLabelBold}>{selectedMapName}</Text>
          </TouchableOpacity>
        </View>
      </View>
